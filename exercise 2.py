...
newsgroupslinkage_matrix = ward(newsgroupsCoocMat.toarray())

'''
ax = dendrogram(newsgroupslinkage_matrix, p=5, truncate_mode='level')
plt.savefig('hierarchy.png')
'''
hierarchicalClusters = fcluster(newsgroupslinkage_matrix, 4, 'maxclust')
df['wald_predictions'] = hierarchicalClusters
print(df)
'''
The result given by the hierarchical clustering is similar to kmeans, suggesting
that there are two major types of documents.
'''